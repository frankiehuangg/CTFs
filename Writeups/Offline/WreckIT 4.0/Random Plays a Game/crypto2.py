...
def enc1():
    ...
    p,q = getPrime(base), getPrime(base) #ukurannya 64
    e = 0x10001
    assert gcd(e, p*q)==1
    return [pow(pl,e,p*q), p*q] #return random, n(128)
...
def enc2():
    ...
    e = 0x10001
    assert gcd(e, p*q)==1
    return [pow(pl,e,p*q), p*q] #return random, n(2048)
...
def enc3():
    ...
    e = 0x10001
    assert gcd(e, p*q)==1
    return [pow(pl,e^0x1000e,p*q), p*q] # return pl, n(1024*1024 = 2048)
...
def enc4():
    ...
    e = 0x10001
    assert gcd(e, p*q)==1
    return [pow(pl,e,p*q), p*q] #return random, n(1028 bit)
